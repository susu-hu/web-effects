...
! function(e, t, n, o, r) {
	...
	function ln(e) {
		...
		for (var t = 1, n = arguments.length; t < n; ++t) {
			var o = arguments[t];
			if (o)
				for (var r in o) o.hasOwnProperty(r) && ("[object Object]" !== Object.prototype.toString.call(o[
					r]) ? e[r] = o[r] : e[r] = ln(e[r], o[r]))
		}
		return e
	}

	function an(e, t) {
		return null != e && (e.classList ? e.classList.contains(t) : new RegExp("(^| )" + t + "( |$)", "gi").test(e
			.className))
	}
	...
	function i(e) {
		return "[object Array]" === Object.prototype.toString.call(e) || "[object NodeList]" === Object.prototype
			.toString.call(e)
	}
	...
	function bn(e, t) {
		...
		for (var n = t.split(" "), o = 0; o < n.length; o++) {
			...
			for (var r = 0; r < e.length; r++) {
				var i = e[r];
				i.classList ? i.classList.remove(t) : i.className = i.className.replace(new RegExp("(^|\\b)" + t
					.split(" ").join("|") + "(\\b|$)", "gi"), " ")
			}
		}
		return e
	...
	function Hn(e, t) {
		return (e.matches || e.matchesSelector || e.msMatchesSelector || e.mozMatchesSelector || e
			.webkitMatchesSelector || e.oMatchesSelector).call(e, t)
	}
	...
	return wt.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function(e, t) {
		...
		function(e, E) {
			var t = E && new RegExp(
				...
				.test(E.licenseKey) || -1 < yt.domain.indexOf("alvarotrigo.com");
			if (!an(rn("html"), kt)) {
				var r = rn("html, body"),
					L = rn("body")[0],
					h = {};
				E = ln({
					...
					scrollOverflowHandler: wt.fp_scrolloverflow ? wt.fp_scrolloverflow.iscrollHandler :
						null,
				...
				pt(), wt.fp_easings = ln(wt.fp_easings, {
					easeInOutCubic: function(e, t, n, o) {
						return (e /= o / 2) < 1 ? n / 2 * e * e * e + t : n / 2 * ((e -= 2) * e * e +
							2) + t
					}
				}), f && (h.version = "3.0.2", h.setAutoScrolling = U, h.setRecordHistory = W, h
					.setScrollingSpeed = X, h.setFitToSection = _, h.setLockAnchors = function(e) {
						E.lockAnchors = e
					}, h.setMouseWheelScrolling = K, h.setAllowScrolling = q, h.setKeyboardScrolling = Q, h
					.moveSectionUp = G, h.moveSectionDown = J, h.silentMoveTo = Z, h.moveTo = ee, h
					.moveSlideRight = te, h.moveSlideLeft = ne, h.fitToSection = de, h.reBuild = oe, h
					.setResponsive = re, h.getFullpageData = E, h.destroy = function(e) {
						U(!1, "internal"), q(!0), $(!1), Q(!1), Sn(f, Tt), clearTimeout(S), clearTimeout(m),
							clearTimeout(s), clearTimeout(k), clearTimeout(M), wt.removeEventListener("scroll",
								fe), wt.removeEventListener("hashchange", ze), wt.removeEventListener("resize",
								_e), yt.removeEventListener("keydown", Ne), yt.removeEventListener("keyup", Pe),
							["click", "touchstart"].forEach(function(e) {
								yt.removeEventListener(e, ie)
							}), ["mouseenter", "touchstart", "mouseleave", "touchend"].forEach(function(e) {
								yt.removeEventListener(e, ae, !0)
							}), clearTimeout(S), clearTimeout(m), e && (ut(0), rn(
									"img[data-src], source[data-src], audio[data-src], iframe[data-src]", f)
								.forEach(function(e) {
									Me(e, "src")
									...
									overflow: "",
									height: ""
								}), bn(rn("html"), kt), bn(L, xt), L.className.split(/\s+/).forEach(function(
								e) {
									0 === e.indexOf(Mt) && bn(L, e)
								}), rn(Bt + ", " + Ut).forEach(function(e) {
									E.scrollOverflowHandler && E.scrollOverflow && E.scrollOverflowHandler
										.remove(e), bn(e, $t + " " + Ot + " " + It);
									var t = e.getAttribute("data-fp-styles");
									t && e.setAttribute("style", e.getAttribute("data-fp-styles")), an(e,
										Ht) && !H && e.removeAttribute("data-anchor")
						...
						translate3dH: function() {
							for (var e = [], t = 0; t < rn(E.sectionSelector, f).length; t++) e.push(
						...
						for (var o in t.style.display = "block", yt.body.insertBefore(t, null), n)
							void 0 !== t.style[o] && (t.style[o] = "translate3d(1px,1px,1px)", e = wt
								.getComputedStyle(t).getPropertyValue(n[o]));
					...
					function() {
						cn(f, {
							height: "100%",
							position: "relative"
						}), Sn(f, Et), Sn(rn("html"), kt), A = sn(), bn(f, Tt), Sn(rn(E.sectionSelector, f),
							Ht), Sn(rn(E.slideSelector, f), Ft);
						for (var e = rn(Bt), t = 0; t < e.length; t++) {
							var n = t,
								o = e[t],
								r = rn(Ut, o),
								i = r.length;
							o.setAttribute("data-fp-styles", o.getAttribute("style")), s = o, (c = n) || null !=
								rn(Rt)[0] || Sn(s, Ot), u = rn(Rt)[0], cn(s, {
									height: A + "px"
								}), E.paddingTop && cn(s, {
								...
								}), void 0 !== E.anchors[c] && s.setAttribute("data-anchor", E.anchors[c]), l =
								o, a = n, void 0 !== E.anchors[a] && an(l, Ot) && Qe(E.anchors[a], a), E.menu &&
								E.css3 && null != xn(rn(E.menu)[0], Lt) && L.appendChild(rn(E.menu)[0]), 0 < i ?
								se(o, r, i) : E.verticalCentered && Je(o)
						}
						var l, a, s, c;
						E.fixedElements && E.css3 && rn(E.fixedElements).forEach(function(e) {
							...
							var n = rn(Vt)[0];
							Sn(n, "fp-" + E.navigationPosition), E.showActiveTooltip && Sn(n,
								"fp-show-active");
							for (var o = "", r = 0; r < rn(Bt).length; r++) {
								var i = "";
								E.anchors.length && (i = E.anchors[r]), o += '<li><a href="#' + i +
									'"><span class="fp-sr-only">' + ce(r, "Section") +
									"</span><span></span></a>";
								var l = E.navigationTooltips[r];
								void 0 !== l && "" !== l && (o += '<div class="' + Yt + " fp-" + E
									.navigationPosition + '">' + l + "</div>"), o += "</li>"
							}
							...
							var t, n, o;
							n = "enablejsapi=1", o = (t = e).getAttribute("src"), t.setAttribute("src",
								o + (/\?/.test(o) ? "&" : "?") + n)
						}), E.scrollOverflow && (p = E.scrollOverflowHandler.init(E))
					}(), q(!0), $(!0), U(E.autoScrolling, "internal"), Ke(), at(), "complete" === yt
					.readyState && Re(), wt.addEventListener("load", Re), E.scrollOverflow || ue(), wt
					.addEventListener("scroll", fe), wt.addEventListener("hashchange", ze), wt.addEventListener(
						"blur", Fe), wt.addEventListener("resize", _e), yt.addEventListener("keydown", Ne), yt
					.addEventListener("keyup", Pe), ["click", "touchstart"].forEach(function(e) {
			...
			function K(e) {
				e ? (function() {
					...
					var n = "onwheel" in yt.createElement("div") ? "wheel" : void 0 !== yt.onmousewheel ?
						"mousewheel" : "DOMMouseScroll";
					"DOMMouseScroll" == n ? yt[e](t + "MozMousePixelScroll", be, !1) : yt[e](t + n, be, !1)
				}(), f.addEventListener("mousedown", De), f.addEventListener("mouseup", Ve)) : (yt
					.addEventListener ? (yt.removeEventListener("mousewheel", be, !1), yt.removeEventListener(
						"wheel", be, !1), yt.removeEventListener("MozMousePixelScroll", be, !1)) : yt
					.detachEvent("onmousewheel", be), f.removeEventListener("mousedown", De), f
					.removeEventListener("mouseup", Ve))
			}
			...
			function $(e) {
				e ? (K(!0), function() {
					if (n || o) {
						...
						var e = rn(Lt)[0];
						e && (e.removeEventListener(O.touchstart, me), e.removeEventListener(O.touchmove,
							he, {
								passive: !1
							}), e.addEventListener(O.touchstart, me), e.addEventListener(O
							.touchmove, he, {
								passive: !1
							}))
					}
			...
			function oe(e) {
				if (!an(f, Tt)) {
					...
					var l = hn(rn(Rt)[0], Bt);
					l && Z(l + 1), g = !1, Cn(E.afterResize) && e && E.afterResize.call(f, wt.innerWidth, wt
						.innerHeight), Cn(E.afterReBuild) && !e && E.afterReBuild.call(f)
				}
			}

			function re(e) {
				var t = an(L, xt);
				e ? t || (U(!1, "internal"), _(!1, "internal"), gn(rn(Vt)), Sn(L, xt), Cn(E.afterResponsive) && E
					.afterResponsive.call(f, e)) : t && (U(I.autoScrolling, "internal"), _(I.autoScrolling,
					"internal"), mn(rn(Vt)), bn(L, xt), Cn(E.afterResponsive) && E.afterResponsive.call(f,
					e))
			}
			...
			function ie(e) {
				...
				t && xn(t, Vt + " a") ? function(e) {
					...
					!rn(E.menu)[0] || !E.lockAnchors && E.anchors.length || (On(e), ee(this.getAttribute(
						"data-menuanchor")))
				}.call(t, e)
			}
			...
			function se(e, t, n) {
				...
				s.className = Kt, yn(t, s), cn(rn(qt, e), {
					width: o + "%"
				}), 1 < n && (E.controlArrows && (l = e, a = [Rn('<div class="fp-controlArrow fp-prev"></div>'),
					Rn('<div class="fp-controlArrow fp-next"></div>')
				], An(rn(_t, l)[0], a), "#fff" !== E.controlArrowColor && (cn(rn(nn, l), {
					"border-color": "transparent transparent transparent " + E.controlArrowColor
				}), cn(rn(tn, l), {
					"border-color": "transparent " + E.controlArrowColor +
						" transparent transparent"
				})), E.loopHorizontal || gn(rn(tn, l))), E.slidesNavigation && function(e, t) {
					wn(Rn('<div class="' + Qt + '"><ul></ul></div>'), e);
					var n = rn(Gt, e)[0];
					Sn(n, "fp-" + E.slidesNavPosition);
					for (var o = 0; o < t; o++) wn(Rn('<li><a href="#"><span class="fp-sr-only">' + ce(o,
						"Slide") + "</span><span></span></a></li>"), rn("ul", n)[0]);
					cn(n, {
				...
				var c = rn(Wt, e)[0];
				null != c && (0 !== hn(rn(Rt), Bt) || 0 === hn(rn(Rt), Bt) && 0 !== hn(c)) ? ct(c, "internal") : Sn(
					t[0], Ot)
			}
			...
			function ue() {
				var e, t = rn(Rt)[0];
				Sn(t, It), Oe(t), Ce(t), E.scrollOverflow && E.scrollOverflowHandler.afterLoad(), (!(e = tt(je()
					.section)) || void 0 !== e && hn(e) === hn(u)) && Cn(E.afterLoad) && Le("afterLoad", {
					activeSection: null,
					element: t,
					direction: null,
			...
			function fe() {
				...
				if (!E.autoScrolling || E.scrollBar) {
					...
					if (t = a, n = rn(Rt)[0].offsetTop, o = n + sn(), ("up" != t ? n <= kn() : o >= kn() + sn()) &&
						(an(rn(Rt)[0], It) || (Sn(rn(Rt)[0], It), bn(Mn(rn(Rt)[0]), It))), !an(e = f[s], Ot)) {
						B = !0;
						var v, p, h = rn(Rt)[0],
							g = hn(h, Bt) + 1,
							m = Ge(e),
						...
						w && (p = w.getAttribute("data-anchor"), v = hn(w)), T && (Sn(e, Ot), bn(Mn(e), Ot), Cn(E
								.onLeave) && Le("onLeave", y), Cn(E.afterLoad) && Le("afterLoad", y), He(h), Oe(
								e), Ce(e), Qe(S, b - 1), E.anchors.length && (x = S), rt(v, p, S)), clearTimeout(k),
			...
			function he(e) {
				...
				if (ge(e)) {
					...
					var n = st(e);
					N = n.y, P = n.x, rn(_t, t).length && Math.abs(j - P) > Math.abs(z - N) ? !a && Math.abs(j -
						P) > wt.innerWidth / 100 * E.touchSensitivity && (P < j ? v.m.right && te(t) : v.m.left &&
							ne(t)) : E.autoScrolling && T && Math.abs(z - N) > wt.innerHeight / 100 * E
						.touchSensitivity && (N < z ? ve("down") : z < N && ve("up"))
				}
			}
			...
			function be(e) {
				...
				if (E.autoScrolling && !c && !n) {
					var o = (e = e || wt.event).wheelDelta || -e.deltaY || -e.detail,
						...
						l = Math.abs(e.wheelDeltaX) < Math.abs(e.wheelDelta) || Math.abs(e.deltaX) < Math.abs(e
							.deltaY) || !i;
			...
			function Ee(e, t, n) {
				if (null != e) {
					var o, r, i, l, a, s, c, u, f, d = {
						...
						callback: t,
						isMovementUp: n,
						dtop: (r = (o = e).offsetHeight, i = o.offsetTop, a = V < (l = i), s = l - A + r, c = E
							.bigSectionsDestination, A < r ? (a || c) && "bottom" !== c || (l = s) : (a ||
								g && null == vn(o)) && (l = s), V = l),
						yMovement: Ge(e),
					...
					if (!(d.activeSection == e && !g || E.scrollBar && kn() === d.dtop && !an(e, Nt))) {
						if (null != d.activeSlide && (u = d.activeSlide.getAttribute("data-anchor"), f = hn(d
								.activeSlide)), !d.localIsResizing) {
							var v = d.yMovement;
							if (void 0 !== n && (v = n ? "up" : "down"), d.direction = v, Cn(E.onLeave) && !1 ===
								Le("onLeave", d)) return
						}
						E.autoScrolling && E.continuousVertical && void 0 !== d.isMovementUp && (!d.isMovementUp &&
								"up" == d.yMovement || d.isMovementUp && "down" == d.yMovement) && ((p = d)
								.isMovementUp ? Tn(rn(Rt)[0], jn(p.activeSection, Bt)) : An(rn(Rt)[0], Nn(p
									.activeSection, Bt).reverse()), ut(rn(Rt)[0].offsetTop), ye(), p
								.wrapAroundElements = p.activeSection, p.dtop = p.element.offsetTop, p.yMovement =
								Ge(p.element), p.leavingSection = hn(p.activeSection, Bt) + 1, p.sectionIndex = hn(p
									.element, Bt), d = p), d.localIsResizing || He(d.activeSection), E
							.scrollOverflow && E.scrollOverflowHandler.beforeLeave(), Sn(e, Ot), bn(Mn(e), Ot), Oe(
								e), E.scrollOverflow && E.scrollOverflowHandler.onLeave(), T = h.test.isTesting, rt(
								f, u, d.anchorLink, d.sectionIndex),
							function(e) {
								if (E.css3 && E.autoScrolling && !E.scrollBar) {
									...
									var n = Te(e.dtop);
									h.test.top = -e.dtop + "px", ht(n.element, n.options, E.scrollingSpeed,
										function() {
			...
			function Le(e, t) {
				var n, o, r, i, l = (o = e, r = t, (i = E.v2compatible ? {
					...
					afterSlideLoad: function() {
						return [r.destiny, r.anchorLink, r.sectionIndex + 1, r.slideAnchor, r
							.slideIndex
						]
					},
					onSlideLeave: function() {
						return [r.prevSlide, r.anchorLink, r.sectionIndex + 1, r.prevSlideIndex, r
							.direction, r.slideIndex
						]
					}
				} : {
					afterRender: function() {
				...
				} else if (In(f, e, l), !1 === E[e].apply(l[Object.keys(l)[0]], (n = l, Object.keys(n).map(function(
						e) {
						return n[e]
					})))) return !1;
				return !0
			...
			function Te(e) {
				var t = {};
				return E.autoScrolling && !E.scrollBar ? (t.options = -e, t.element = rn(Lt)[0]) : (t.options = e, t
					.element = wt), t
			}

			function ke(e) {
				var t;
				null != (t = e).wrapAroundElements && (t.isMovementUp ? Tn(rn(Bt)[0], t.wrapAroundElements) : An(rn(
						Bt)[rn(Bt).length - 1], t.wrapAroundElements), ut(rn(Rt)[0].offsetTop), ye()), Cn(E
						.afterLoad) && !e.localIsResizing && Le("afterLoad", e), E.scrollOverflow && E
					.scrollOverflowHandler.afterLoad(), e.localIsResizing || Ce(e.element), Sn(e.element, It), bn(
						Mn(e.element), It), T = !0, Cn(e.callback) && e.callback()
			}
			...
			function He(e) {
				...
				rn("video, audio", t).forEach(function(e) {
					...
					/youtube\.com\/embed\//.test(e.getAttribute("src")) && !e.hasAttribute(
						"data-keepplaying") && e.contentWindow.postMessage(
			...
			function Ne(e) {
				...
				9 === n ? function(e) {
						...
						}(t = e, n = Ye(yt), o = n.indexOf(yt.activeElement), r = t.shiftKey ? o - 1 : o + 1, i = n[
							r], l = Ae(xn(i, Ut)), a = xe(xn(i, Bt)), l || a) && (c ? null == xn(c, Rt + "," + Rt +
								" " + Wt) && (c = f(e)) : f(e), (!s && c == u[u.length - 1] || s && c == u[0]) &&
							On(e))
					}(e) : Hn(t, "textarea") || Hn(t, "input") || Hn(t, "select") || "true" === t.getAttribute(
						"contentEditable") || "" === t.getAttribute("contentEditable") || !E.keyboardScrolling || !E
					.autoScrolling || (-1 < [40, 38, 32, 33, 34].indexOf(n) && On(e), c = e.ctrlKey, b = setTimeout(
						function() {
							! function(e) {
								var t = e.shiftKey;
			...
			function We(e, t, n) {
				...
				l.xMovement = (o = l.prevSlideIndex, r = l.slideIndex, o == r ? "none" : r < o ? "left" : "right"),
					l.localIsResizing || (T = !1), E.onSlideLeave && !l.localIsResizing && "none" !== l.xMovement &&
					Cn(E.onSlideLeave) && !1 === Le("onSlideLeave", l) ? a = !1 : (Sn(t, Ot), bn(Mn(t), Ot), l
						.localIsResizing || (He(l.prevSlide), Oe(t)), !E.loopHorizontal && E.controlArrows && (Bn(
							rn(tn, i), 0 !== l.slideIndex), Bn(rn(nn, i), null != vn(t))), an(i, Ot) && !l
						.localIsResizing && rt(l.slideIndex, l.slideAnchor, l.anchorLink, l.sectionIndex),
						function(e, t, n) {
							var o = t.destinyPos;
							if (E.css3) {
								var r = "translate3d(-" + Math.round(o.left) + "px, 0px, 0px)";
								h.test.translate3dH[t.sectionIndex] = r, cn(qe(rn(qt, e)), ft(r)), S = setTimeout(
									function() {
										n && Xe(t)
									}, E.scrollingSpeed)
							} else h.test.left[t.sectionIndex] = Math.round(o.left), ht(e, Math.round(o.left), E
								.scrollingSpeed,
								function() {
									n && Xe(t)
								})
			...
			function Xe(e) {
				var t, n;
				t = e.slidesNav, n = e.slideIndex, E.slidesNavigation && null != t && (bn(rn(Ct, t), Ot), Sn(rn("a",
					rn("li", t)[n]), Ot)), e.localIsResizing || (Cn(E.afterSlideLoad) && Le("afterSlideLoad",
					e), T = !0, Ce(e.destiny)), a = !1
			}
			...
			function Qe(e, t) {
				var n, o, r, i;
				n = e, o = rn(E.menu)[0], E.menu && null != o && (bn(rn(Ct, o), Ot), Sn(rn('[data-menuanchor="' +
					n + '"]', o), Ot)), r = e, i = t, E.navigation && null != rn(Vt)[0] && (bn(rn(Ct, rn(Vt)[
					0]), Ot), Sn(r ? rn('a[href="#' + r + '"]', rn(Vt)[0]) : rn("a", rn("li", rn(Vt)[0])[
					i]), Ot))
			}
			...
			function Ze(e) {
				...
				if (E.paddingTop || E.paddingBottom) {
					var n = e;
					an(n, Ht) || (n = xn(e, Bt));
					var o = parseInt(getComputedStyle(n)["padding-top"]) + parseInt(getComputedStyle(n)[
						"padding-bottom"]);
					t = A - o
				}
				return t
			...
			function nt(e, t) {
				var n = tt(e);
				if (null != n) {
					var o, r, i, l = (null == (i = rn(Ut + '[data-anchor="' + (o = t) + '"]', r = n)[0]) && (o =
						void 0 !== o ? o : 0, i = rn(Ut, r)[o]), i);
			...
			function rt(e, t, n, o) {
				var r = "";
				E.anchors.length && !E.lockAnchors && (e ? (null != n && (r = n), null == t && (t = e), it(r + "/" +
					(i = t))) : (null != e && (i = t), it(n))), at()
			}
			...
			function st(e) {
				var t = [];
				return t.y = void 0 !== e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY, t.x =
					void 0 !== e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX, o && ge(e) && E
					.scrollBar && void 0 !== e.touches && (t.y = e.touches[0].pageY, t.x = e.touches[0].pageX), t
			}

			function ct(e, t) {
				X(0, "internal"), void 0 !== t && (g = !0), We(xn(e, _t), e), void 0 !== t && (g = !1), X(I
			...
			function pt() {
				t || (on("error",
						...
						), on("error", "https://github.com/alvarotrigo/fullPage.js#options.")), an(rn("html"), kt) ?
					on("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (
						E.continuousVertical && (E.loopTop || E.loopBottom) && (E.continuousVertical = !1, on(
							"warn",
							"Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled"
							)), !E.scrollOverflow || !E.scrollBar && E.autoScrolling || on("warn",
							...
							), !E.continuousVertical || !E.scrollBar && E.autoScrolling || (E.continuousVertical = !
							1, on("warn",
							...
							on("error",
								...
								)), ["fadingEffect", "continuousHorizontal", "scrollHorizontally",
							"interlockedSlides", "resetSliders", "responsiveSlides", "offsetSections",
							"dragAndMove", "scrollOverflowReset", "parallax"
						].forEach(function(e) {
							E[e] && on("warn",
							...
							var e = [].slice.call(rn("[name]")).filter(function(e) {
									return e.getAttribute("name") && e.getAttribute("name").toLowerCase() ==
										t.toLowerCase()
								}),
								n = [].slice.call(rn("[id]")).filter(function(e) {
									return e.getAttribute("id") && e.getAttribute("id").toLowerCase() == t
										.toLowerCase()
								});
							(n.length || e.length) && (on("error",
								"data-anchor tags can not have the same value as any `id` element on the site (or `name` element for IE)."
								), n.length && on("error", '"' + t +
								'" is is being used by another element `id` property'), e.length && on(
								"error", '"' + t + '" is is being used by another element `name` property'))
						}))
			}

			function ht(t, n, o, r) {
				var e, i = (e = t).self != wt && an(e, Xt) ? e.scrollLeft : !E.autoScrolling || E.scrollBar ? kn() :
					e.offsetTop,
					l = n - i,
					a = 0;
				w = !0;
				var s = function() {
					if (w) {
						var e = n;
						a += 20, o && (e = wt.fp_easings[E.easing](a, i, l, o)), gt(t, e), a < o ? setTimeout(s,
							20) : void 0 !== r && r()
					} else a < o && r()
				};
				s()
			...
			function gt(e, t) {
				!E.autoScrolling || E.scrollBar || e.self != wt && an(e, Xt) ? e.self != wt && an(e, Xt) ? e
					.scrollLeft = t : e.scrollTo(0, t) : e.style.top = t + "px"
			}

			function mt(e, t) {
				this.anchor = e.getAttribute("data-anchor"), this.item = e, this.index = hn(e, t), this.isLast =
					this.index === e.parentElement.querySelectorAll(t).length - 1, this.isFirst = !this.index
			}
